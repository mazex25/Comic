...
import com.example.appdoctruyen.model.DoiThuong;
import com.example.appdoctruyen.model.LichSuDocTruyen;
import com.example.appdoctruyen.model.Model_TimKiem;
import com.example.appdoctruyen.model.NoiDungChapter;
import com.example.appdoctruyen.model.PLTruyen;
import com.example.appdoctruyen.model.TaiKhoan;
import com.example.appdoctruyen.model.ThongBao;
import com.example.appdoctruyen.model.ThongKe;
import com.example.appdoctruyen.model.Truyen;
import com.example.appdoctruyen.model.VatPham;
...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE if not exists taikhoan (\n" +
                ...
                ");\n");
        // insert taikhoan
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (1, 'trongpro0009@gmail.com', '@Trong123', 'Nguyễn Minh Trọng', '0358126179', 60, 1, NULL);");
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (2, 's22062000s@gmail.com', '@Trong1234', 'Nguyễn Minh Trọng', NULL, 140, 0, 'https://i.pinimg.com/236x/06/2f/8f/062f8f8d0f731a00e565a45606339762.jpg');");
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (3, '1824801040088@student.tdmu.edu.vn', '@Trong123', 'Nguyễn Anh Đại', NULL, 150, 0, NULL);");
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (4, '1824801040101@student.tdmu.edu.vn', '@Trong123', 'Đoàn Công Hậu', NULL, 230, 0, NULL);");
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (5, '1824801040112@student.tdmu.edu.vn', '@Trong123', 'Nguyễn Thị Bích Liên', NULL, 120, 0, NULL);");
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (6, '1824801040116@student.tdmu.edu.vn', '@Trong123', 'Huỳnh Gia Cường', NULL, 70, 0, NULL);");
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (7, '1824801040081@student.tdmu.edu.vn', '@Trong123', 'Nguyễn Văn Nam', NULL, 90, 0, NULL);");
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (8, '1824801040064@student.tdmu.edu.vn', '@Trong123', 'Quách Kế Thanh', NULL, 125, 0, NULL);");
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (9, 'trong@gmail.com', '@Trong123', NULL, NULL, 0, 2, NULL);");
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (10, 'trong123@gmail.com', '@Trong123', NULL, NULL, 150, 0, NULL);");
        ...
        db.execSQL("CREATE TABLE if not exists truyen (\n" +
                ...
                ");");
        //insert truyen
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (1, 'ĐỆ NHẤT DANH SÁCH', 'Đang cập nhật', 'Trên mảnh đất chết này, văn minh nhân loại chỉ có thể kéo dài hơi tàn.Từng tòa nhà được gọi là hàng rào dần mọc lên, luật pháp và trật tự sụp đổ. Có người nói, khi thảm họa phủ xuống trái đất, ý chí của con người là vũ khí đệ nhất để vượt qua nguy hiểm.Có người nói, đừng để bi ai của thời đại trở thành bi ai của ngươi.Có người lại nói, ta muốn để bi ai của mình trở thành bi ai của thời đại. Một chuyện xưa mới bắt đầu. Qua khoảng thời gian hạo kiếp, ánh dương lần nữa trở lại.', 'Action', 'https://st.imageinstant.net/data/comics/186/de-nhat-danh-sach.jpg', 0, 'de nhat danh sach');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (2, 'VÕ LUYỆN ĐỈNH PHONG', 'Đang cập nhật', 'Võ đạo đỉnh phong, là cô độc, là tịch mịch, là dài đằng đẵng cầu tác, là cao xử bất thắng hàn.Phát triển trong nghịch cảnh, cầu sinh nơi tuyệt địa, bất khuất không buông tha, mới có thể có thể phá võ chi cực đạo.Lăng Tiêu các thí luyện đệ tử kiêm quét rác gã sai vặt Dương Khai ngẫu lấy được một bản vô tự hắc thư, từ nay về sau đạp vào dài đằng đẵng võ đạo.', 'Action', 'https://st.imageinstant.net/data/comics/32/vo-luyen-dinh-phong.jpg', 0, 'vo luyen dinh phong');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (3, 'THÔNG U ĐẠI THÁNH', 'Đang cập nhật', 'Cố thành ý bỏ mình ngoài ý muốn, xuyên không đến một thế giới tiên hiệp chí quái trở thành xuống dốc quý tộc Đại Càn trung dũng Hầu phủ Đại công tử. Vì tránh né di nương ám sát, rời đi kinh thành, gia nhập trừng trị thiên địa Võng Lượng tĩnh đêm ti. Quỷ bí giang hồ, yêu dị nhiều lần ra, triều đình mục nát, võ lâm thế gia, quần hùng cũng', 'Action', 'https://st.imageinstant.net/data/comics/65/thong-u-dai-thanh.jpg', 0, 'thong u dai thanh');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (4, 'TA LÀ CHÍ TÔN', 'Đang cập nhật', 'Nam chính vô địch, trùng sinh trở thành công tử ngốc nghếch. Hãy cùng xem bằng cách nào lấy lại tu vi, tuyên bố chúng sinh: \"Ta là Thánh Tôn!\"', 'Action', 'https://st.imageinstant.net/data/comics/8/ta-la-chi-ton.jpg', 0, 'ta la chi ton');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (5, 'THƯƠNG NGUYÊN ĐỒ', 'Đang cập nhật', 'Ta tên Mạnh Xuyên, năm nay mười lăm tuổi, là Đông Ninh phủ \"Kính Hồ đạo viện\" đương đại đại sư huynh.', 'Cổ Đại', 'https://st.imageinstant.net/data/comics/236/thuong-nguyen-do.jpg', 0, 'thuong nguyen do');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (6, 'THẦN HỒN VÕ ĐẾ', 'Đang cập nhật', 'Truyện tranh Thần Hồn Võ Đế được cập nhật nhanh và đầy đủ nhất tại Argon Comic. Bạn đọc đừng quên để lại bình luận và chia sẻ, ủng hộ Argon Comic ra các chương mới nhất của truyện Thần Hồn Võ Đế.', 'Cổ Đại', 'https://st.imageinstant.net/data/comics/183/than-hon-vo-de.jpg', 0, 'than hon vo de');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (7, 'LĂNG THIÊN THẦN ĐẾ', 'Đang cập nhật', 'Truyện tranh Lăng Thiên Thần Đế được cập nhật nhanh và đầy đủ nhất tại NetTruyen. Bạn đọc đừng quên để lại bình luận và chia sẻ, ủng hộ NetTruyen ra các chương mới nhất của truyện Lăng Thiên Thần Đế.', 'Cổ Đại', 'https://st.imageinstant.net/data/comics/83/lang-thien-than-de.jpg', 0, 'lang thien than de');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (8, 'TU LA KIẾM TÔN', 'Đang cập nhật', 'Truyện tranh Tu La Kiếm Tôn được cập nhật nhanh và đầy đủ nhất tại NetTruyen. Bạn đọc đừng quên để lại bình luận và chia sẻ, ủng hộ NetTruyen ra các chương mới nhất của truyện Tu La Kiếm Tôn.', 'Cổ Đại', 'https://st.imageinstant.net/data/comics/219/tu-la-kiem-ton.jpg', 0, 'tu la kiem ton');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (9, 'KHOA KỸ ĐẠI TIÊN TÔNG', 'Đang cập nhật', 'Vốn là học bá IQ cao thời hiện đại, bậc thầy chế tạo thủ công, bởi vì thức đêm làm việc quá sức mà chết, xuyên không đến thế giới tu tiên huyền nguyên đại lục nhập vào thân thể một tên phú nhị đại trong một gia tộc nghèo Tô Cảnh Nghiêu dựa vào tri thức hiện đại, kết hợp với bàn tay vàng bật hack để tu tiên, phi thăng cấp tốc, ở tu tiên giới mở ra những nghiên cứu về sản phẩm khoa học kỹ thuật chấn kinh ánh mắt của đám tu tiên giả, tạo ra một thời đại mới, trở thành đại lão, cùng các mỹ nữ đi lên đỉnh phong nhân sinh Ở học viện đọ sức cùng thiên tài, trở thành nhất bảng top 100; Dẫn đầu học viện tham gia tranh bá, bản thân trở thành đệ nhất nhân của nam vực; lãnh đạo tông môn đánh boss, cuối cùng trở thành truyền thuyết đại lục', 'Harem', 'https://st.imageinstant.net/data/comics/165/khoa-ky-dai-tien-tong.jpg', 0, 'khoa ky dai tien tong');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (10, 'VÕ THẦN CHÚA TỂ', 'Đang cập nhật', 'Thiên Vũ đại lục nhất đại truyền kỳ Tần Trần, bởi vì bạn tốt phản bội bất ngờ ngã xuống Võ vực. 300 năm sau, hắn chuyển sinh ở một cái nhận hết ức hiếp vương phủ con riêng trên người, lợi dụng kiếp trước trình độ, ngưng thần công, luyện thần đan, đi ngược lên trời, quật khởi mạnh mẽ, từ đây bước lên một đoạn khiếp sợ đại lục kinh thế lữ trình.', 'Harem', 'https://st.imageinstant.net/data/comics/71/vo-than-chua-te.jpg', 0, 'vo than chua te');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (11, 'TA LÀ ĐẠI THẦN TIÊN', 'Đang cập nhật', 'Thần đồng tên giang mới có bảy tuổi sinh trưởng quá nhanh nên bị đoản mệnh, vì là khôi phục cuộc sống bình thường, mang theo ký ức trong cơ thể một vị đại thần tiên xông vào Tiên giới, từ đây đi tới trở thành bá chủ Tiên giới mở ra con đường truyền kỳ...', 'Harem', 'https://st.imageinstant.net/data/comics/133/ta-la-dai-than-tien.jpg', 0, 'ta la dai than tien');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (12, 'ĐƯỜNG DẦN TẠI DỊ GIỚI', 'Đang cập nhật', 'Thể loại huyền huyễn dị giới theo nguyên tác của Lục Đạo. Hắn có một thân công phu siêu quần bạt tụy, trong thế giới hiện thực không đất dụng võ, chỉ còn cách làm sát thủ. Tình cờ đến được Dị giới vào thời thế hỗn loạn, trên chiến trường phát huy thực lực. Tên hắn là Đường Dần, chuyện của hắn như chỉ tồn tại trong truyền thuyết...', 'Harem', 'https://st.imageinstant.net/data/comics/114/duong-dan-tai-di-gioi.jpg', 1, 'duong dan tai di gioi');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (13, 'THANH NINH CHI HẠ ', 'Đang cập nhật', 'Nữ chính của chúng ta, Ninh Đóa Đóa, sau khi chuyển trường từ thành phố S về thành phố Q ven biển, ngày đầu tiên đi học, đã phát hiện ra một anh học bá trâu nhất trường, cũng là đệ nhất soái cơ, đang trốn một góc khóc hu hu do cô lạc đường khi tới trường, họ chia tay nhau khi cảm xúc đôi bên không mấy vui vẻ cho lắm.', 'Trinh Thám', 'https://st.imageinstant.net/data/comics/34/thanh-ninh-chi-ha.jpg', 1, 'thanh ninh chi ha');");
        ...
        //insert chapter
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (1, 1, 'Chapter 1', '2019-03-31', 25, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (2, 1, 'Chapter 2', '2019-04-09', 13, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (3, 1, 'Chapter 3', '2019-04-11', 10, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (4, 2, 'Chapter 1', '2018-01-02', 5, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (5, 2, 'Chapter 2', '2018-01-03', 4, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (6, 2, 'Chapter 3', '2018-01-03', 3, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (7, 3, 'Chapter 1', '2021-06-24', 8, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (8, 3, 'Chapter 2', '2021-06-24', 9, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (9, 3, 'Chapter 3', '2021-06-25', 8, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (10, 4, 'Chapter 1', '2021-05-28', 3, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (11, 4, 'Chapter 2', '2021-05-28', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (12, 4, 'Chapter 3', '2021-06-04', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (13, 5, 'Chapter 1', '2020-02-06', 1, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (14, 5, 'Chapter 2', '2020-02-06', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (15, 5, 'Chapter 3', '2020-02-10', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (16, 6, 'Chapter 1', '2020-07-13', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (17, 6, 'Chapter 2', '2020-07-13', 1, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (18, 6, 'Chapter 3', '2020-07-13', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (19, 7, 'Chapter 1', '2020-05-21', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (20, 7, 'Chapter 2', '2020-05-21', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (21, 7, 'Chapter 3', '2020-05-21', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (22, 8, 'Chapter 1', '2020-03-19', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (23, 8, 'Chapter 2', '2020-03-19', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (24, 8, 'Chapter 3', '2020-03-19', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (25, 9, 'Chapter 1', '2021-06-12', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (26, 9, 'Chapter 2', '2021-06-12', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (27, 9, 'Chapter 3', '2021-06-12', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (28, 10, 'Chapter 1', '2017-04-30', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (29, 10, 'Chapter 2', '2017-04-30', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (30, 10, 'Chapter 3', '2017-05-01', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (31, 11, 'Chapter 1', '2018-10-21', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (32, 11, 'Chapter 2', '2018-10-28', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (33, 11, 'Chapter 3', '2018-10-28', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (34, 12, 'Chapter 1', '2016-04-03', 8, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (35, 12, 'Chapter 2', '2016-04-04', 16, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (36, 12, 'Chapter 3', '2016-04-05', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (37, 13, 'Chapter 1', '2016-09-23', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (38, 13, 'Chapter 2', '2016-09-24', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (39, 13, 'Chapter 3', '2016-09-26', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (40, 14, 'Chapter 1', '2020-11-09', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (41, 14, 'Chapter 2', '2020-11-09', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (42, 14, 'Chapter 3', '2020-11-11', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (43, 15, 'Chapter 1', '2020-03-16', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (44, 15, 'Chapter 2', '2020-03-24', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (45, 15, 'Chapter 3', '2020-03-24', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (46, 16, 'Chapter 1', '2020-03-09', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (47, 16, 'Chapter 2', '2020-03-09', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (48, 16, 'Chapter 3', '2020-03-09', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (49, 17, 'Chapter 1', '2021-01-23', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (50, 17, 'Chapter 2', '2021-01-23', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (51, 17, 'Chapter 3', '2021-01-23', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (52, 18, 'Chapter 1', '2019-07-17', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (53, 18, 'Chapter 2', '2019-07-19', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (54, 18, 'Chapter 3', '2019-07-19', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (55, 19, 'Chapter 1', '2015-04-29', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (56, 19, 'Chapter 2', '2015-04-30', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (57, 19, 'Chapter 3', '2015-05-01', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (58, 20, 'Chapter 1', '2016-05-03', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (59, 20, 'Chapter 2', '2016-05-03', 0, 0.0);");
        db.execSQL("INSERT INTO chapter (id, idtruyen, tenchapter, ngaydang, soluotxem, danhgia) VALUES (60, 20, 'Chapter 3', '2016-05-03', 0, 0.0);");
        ...
        db.execSQL("INSERT INTO noidungchapter (id, idchapter, linkanh) VALUES (1, 1, 'https://anhnhanh.org/data/images/49082/770002/002.jpg?data=net');");
        db.execSQL("INSERT INTO noidungchapter (id, idchapter, linkanh) VALUES (2, 1, 'https://anhnhanh.org/data/images/49082/770002/003.jpg?data=net');");
        db.execSQL("INSERT INTO noidungchapter (id, idchapter, linkanh) VALUES (3, 1, 'https://anhnhanh.org/data/images/49082/770002/004.jpg?data=net');");
        db.execSQL("INSERT INTO noidungchapter (id, idchapter, linkanh) VALUES (4, 1, 'https://anhnhanh.org/data/images/49082/770002/005.jpg?data=net');");
        db.execSQL("INSERT INTO noidungchapter (id, idchapter, linkanh) VALUES (5, 1, 'https://anhnhanh.org/data/images/49082/770002/006.jpg?data=net');");
        ...
        //insert binhluan
        db.execSQL("INSERT INTO binhluan (id, idchapter, idtaikhoan, noidung, ngaydang, trangthai) VALUES (1, 35, 2, 'truyện hay quá bạn ơi!', '2021-11-21', 1);");
        db.execSQL("INSERT INTO binhluan (id, idchapter, idtaikhoan, noidung, ngaydang, trangthai) VALUES (2, 35, 2, 'tuyệt vời!', '2021-11-21', 1);");
        db.execSQL("INSERT INTO binhluan (id, idchapter, idtaikhoan, noidung, ngaydang, trangthai) VALUES (3, 35, 2, 'tuyệt vời!', '2021-11-21', 1);");
        db.execSQL("INSERT INTO binhluan (id, idchapter, idtaikhoan, noidung, ngaydang, trangthai) VALUES (4, 35, 2, 'tuyệt vời!', '2021-11-21', 1);");
        db.execSQL("INSERT INTO binhluan (id, idchapter, idtaikhoan, noidung, ngaydang, trangthai) VALUES (5, 35, 2, 'a', '2021-11-21', 1);");
        db.execSQL("INSERT INTO binhluan (id, idchapter, idtaikhoan, noidung, ngaydang, trangthai) VALUES (6, 35, 2, 'b', '2021-11-21', 1);");
        ...
        //insert danhgia
        db.execSQL("INSERT INTO danhgia (id, idchapter, idtaikhoan, sosao, ngaydanhgia) VALUES (1, 35, 2, 5.0, '2021-11-21');");
        db.execSQL("INSERT INTO danhgia (id, idchapter, idtaikhoan, sosao, ngaydanhgia) VALUES (2, 1, 3, 2.5, '2021-11-21');");
        db.execSQL("INSERT INTO danhgia (id, idchapter, idtaikhoan, sosao, ngaydanhgia) VALUES (3, 1, 4, 4.0, '2021-11-21');");
        db.execSQL("INSERT INTO danhgia (id, idchapter, idtaikhoan, sosao, ngaydanhgia) VALUES (4, 12, 1, 4.0, '2021-11-21');");
        db.execSQL("INSERT INTO danhgia (id, idchapter, idtaikhoan, sosao, ngaydanhgia) VALUES (5, 12, 2, 3.5, '2021-11-21');");
        db.execSQL("INSERT INTO danhgia (id, idchapter, idtaikhoan, sosao, ngaydanhgia) VALUES (6, 4, 3, 3.0, '2021-11-21');");
        db.execSQL("INSERT INTO danhgia (id, idchapter, idtaikhoan, sosao, ngaydanhgia) VALUES (7, 35, 1, 4.0, '2021-11-21');");
        ...
        db.execSQL("CREATE TABLE if not exists diemthuong (\n" +
                ...
                ");\n");
        //insert diemthuong
        db.execSQL("INSERT INTO diemthuong (id, idtaikhoan, diem, ngaynhan, thu) VALUES (9, 2, 5, '2021-11-20', 1);");
        db.execSQL("INSERT INTO diemthuong (id, idtaikhoan, diem, ngaynhan, thu) VALUES (10, 1, 5, '2021-11-20', 1);");
        db.execSQL("INSERT INTO diemthuong (id, idtaikhoan, diem, ngaynhan, thu) VALUES (11, 8, 5, '2021-11-20', 1);");
        db.execSQL("INSERT INTO diemthuong (id, idtaikhoan, diem, ngaynhan, thu) VALUES (12, 2, 5, '2021-11-24', 1);");
        db.execSQL("INSERT INTO diemthuong (id, idtaikhoan, diem, ngaynhan, thu) VALUES (13, 2, 5, '2021-11-25', 2);");
        ...
        db.execSQL("CREATE TABLE if not exists doithuong (\n" +
                ...
                ");\n");
        //insert doithuong
        db.execSQL("INSERT INTO doithuong (id, idvatpham, idtaikhoan, ngaydoi) VALUES (1, 6, 2, '2021-11-20');");
        db.execSQL("INSERT INTO doithuong (id, idvatpham, idtaikhoan, ngaydoi) VALUES (2, 1, 2, '2021-11-20');");
        ...
        db.execSQL("CREATE TABLE if not exists thongbao (\n" +
                ...
                ");\n");
        //insert thongbao
        db.execSQL("INSERT INTO thongbao (id, tieude, noidung, ngaydang) VALUES (1, 'Xử lý vi phạm', 'Những tài khoản có bình luận văn tục, bôi nhọ danh dự của cá nhân, tổ chức sẽ bị khóa vĩnh viễn. Thông tin đến đọc giả.', '2021-11-19');");
        db.execSQL("INSERT INTO thongbao (id, tieude, noidung, ngaydang) VALUES (2, 'Bảo trì hệ thống', 'Hệ thống ứng dụng đọc truyện Argon Comic xin phép tạm dừng vào ngày 06-12-2021 để bảo trì. Thông tin đến đọc giả.', '2021-12-05');");
